...
> **Canonical build spec: `docs/00-INDEX.md`** (12 section docs, written for a build agent). This file = exploration knowledge/history. NO GIT REPO YET — do not build.
...
- **Open items:** carry MCS-Dev into v2 as a product/scope preset?; norm threshold + promotion policy sign-off.
